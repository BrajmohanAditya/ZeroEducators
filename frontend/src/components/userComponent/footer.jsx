...
const Footer = () => {
  ...
  const examLinks = [
    { label: "SBI PO & Clerk Complete Batch", href: "#" },
    { label: "IBPS PO / Clerk Target 2026", href: "#" },
    { label: "RBI Grade B & Assistant Course", href: "#" },
    { label: "IBPS RRB Officer Scale I & II", href: "#" },
    { label: "Banking & Financial Awareness", href: "#" },
    { label: "Quantitative Aptitude Special", href: "#" },
    { label: "Reasoning Ability Masterclass", href: "#" },
    { label: "English for Banking Exams", href: "#" },
    { label: "All India Banking Mock Tests", href: "#" },
    { label: "Daily Current Affairs & Editorial", href: "#" },
  ];
  ...
  const socialLinks = [
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/mszero2infinity?stkn=MXZvdnZmZnE5dXhxNg==",
      icon: (
  ...
  return (
    <footer style={{ fontFamily: "'Outfit', 'Poppins', 'Inter', sans-serif" }}>
      {/* ── Newsletter CTA Strip ── */}
      <div
        style={{
          background:
            "linear-gradient(135deg, #071830 0%, #0d3263 50%, #071830 100%)",
      ...
      >
        ...
        >
          <div>
            ...
            >
              Ready to Crack Banking & Govt. Exams?
            </h2>
            <p
              style={{
                fontSize: "14px",
            ...
            >
              Subscribe for daily current affairs, banking awareness, and
              exclusive study material delivered straight to your inbox.
            </p>
          </div>
      ...
      <div
        style={{
          background: "linear-gradient(180deg, #051024 0%, #020612 100%)",
      ...
      >
        ...
        >
          ...
          <div style={{ gridColumn: "span 1" }}>
            ...
            >
              <div
                style={{
                  ...
                  height: "50px",
                  borderRadius: "12px",
                  background: "linear-gradient(135deg, #0c2b57, #071933)",
                  border: "1px solid rgba(212,175,55,0.4)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  boxShadow: "0 0 20px rgba(11,92,184,0.25)",
                }}
              >
            ...
            >
              India's premier online learning platform for Banking, Insurance,
              and Competitive Exam preparation with top educators, full mock
              tests, and comprehensive study materials.
            </p>
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              {socialLinks.map((s) => (
                <a
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "rgba(11,92,184,0.3)";
          ...
          <div>
              ...
              >
                <div
                  style={{
                    ...
                    height: "32px",
                    borderRadius: "8px",
                    background: "rgba(11,92,184,0.15)",
                    border: "1px solid rgba(11,92,184,0.3)",
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    flexShrink: 0,
            ...
            <div
              style={{
                ...
                padding: "16px",
                borderRadius: "10px",
                background: "rgba(11,92,184,0.08)",
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
            <p style={{ fontSize: "12px", color: "#64748b", margin: 0 }}>
              &copy; {new Date().getFullYear()} Zero Educators. All rights
              reserved.
            </p>
